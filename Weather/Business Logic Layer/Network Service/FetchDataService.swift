...
final class FetchDataService<T: Decodable> {
    ...
    func fetchWeatherData(coordinates: (latitude: Double, longitude: Double), completion: @escaping (Result<T,FetchDataError>) -> Void) {
    ...
    func fetchAirQualityData(coordinates: (latitude: Double, longitude: Double), completion: @escaping (Result<T,FetchDataError>) -> Void) {
