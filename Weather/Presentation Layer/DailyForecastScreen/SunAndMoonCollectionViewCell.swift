            ...
            if row == 0 {
                ...
                if let sunrise = filteredForecast[index].sunrise,
                   let sunset = filteredForecast[index].sunset {
                    ...
                    case .twelveHour:
                        riseTimeLabel.text = CustomDateFormatter().formattedStringToString(date: sunrise, dateFormat: "hh:mm a", locale: nil, timeZone: TimeZone(identifier: model.weather?.timeZone ?? ""))
                        setTimeLabel.text = CustomDateFormatter().formattedStringToString(date: sunset, dateFormat: "hh:mm a", locale: nil, timeZone: TimeZone(identifier: model.weather?.timeZone ?? ""))
                    case .twentyFourHour:
                        riseTimeLabel.text = CustomDateFormatter().formattedStringToString(date: sunrise, dateFormat: "HH:mm", locale: nil, timeZone: TimeZone(identifier: model.weather?.timeZone ?? ""))
                        setTimeLabel.text = CustomDateFormatter().formattedStringToString(date: sunset, dateFormat: "HH:mm", locale: nil, timeZone: TimeZone(identifier: model.weather?.timeZone ?? ""))
                    }
                ...
                if let moonrise = filteredForecast[index].moonrise,
                   let moonset = filteredForecast[index].moonset {
                    switch units.timeFormat {
                    case .twelveHour:
                        riseTimeLabel.text = CustomDateFormatter().formattedStringToString(date: moonrise, dateFormat: "hh:mm a", locale: nil, timeZone: TimeZone(identifier: model.weather?.timeZone ?? ""))
                        setTimeLabel.text = CustomDateFormatter().formattedStringToString(date: moonset, dateFormat: "hh:mm a", locale: nil, timeZone: TimeZone(identifier: model.weather?.timeZone ?? ""))
                    case .twentyFourHour:
                        riseTimeLabel.text = CustomDateFormatter().formattedStringToString(date: moonrise, dateFormat: "HH:mm", locale: nil, timeZone: TimeZone(identifier: model.weather?.timeZone ?? ""))
                        setTimeLabel.text = CustomDateFormatter().formattedStringToString(date: moonset, dateFormat: "HH:mm", locale: nil, timeZone: TimeZone(identifier: model.weather?.timeZone ?? ""))
                    }
